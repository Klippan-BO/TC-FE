...
function TrailDescription({ name, description }) {
  ...
  const CLIENT_ID = "80779173779-drt9i52d5c05bmt5m013vjkhmg6q41an.apps.googleusercontent.com";
  ...
  const handleClick = () => {
    g.load('client:auth2', () => {
      ...
      const request = g.client.calendar.events.insert({
        calendarId: 'primary',
        resource: event,
      });
